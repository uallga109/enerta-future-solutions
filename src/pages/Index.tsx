...
const Index = () => {
  return <Layout>
      ...
      <section className="relative enerta-section overflow-hidden">
        <div className="absolute inset-0">
          <img src={mejoradoraBg} alt="Paneles solares" className="w-full h-full object-cover" />
        ...
        <div className="enerta-container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-primary-foreground/90 text-lg leading-relaxed space-y-4 mb-8">
              <p>
                En Enerta Future colaboramos con Mejoradora, una comercializadora eléctrica que ofrece tarifas competitivas y transparentes para hogares y empresas.
              </p>
              <p>
                Gracias a esta colaboración, si cambias tu compañía de luz a Mejoradora, podrás acceder a ofertas exclusivas en los servicios de Enerta Future, como instalaciones eléctricas, fotovoltaica, puntos de carga para vehículos eléctricos o climatización.
              </p>
              <p>
                Nuestro objetivo es doble: <strong className="text-primary-foreground">ayudarte a pagar menos en tu factura eléctrica</strong> y ofrecerte soluciones energéticas completas, con un único equipo de confianza que te acompaña antes, durante y después.
              </p>
              <p>
