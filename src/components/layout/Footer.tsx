...
const Footer = () => {
  return (
    <footer className="bg-[hsl(80_30%_18%)] text-primary-foreground">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:639089786" className="text-primary-foreground/70 hover:text-primary transition-colors text-sm">
                  639 089 786
                </a>
              </li>
              <li className="flex items-center gap-3">
